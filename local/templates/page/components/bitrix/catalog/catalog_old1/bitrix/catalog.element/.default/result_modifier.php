...
//link
$arResult["BET_LINK"] = array();
$arOrder = array("ACTIVE_FROM" => "DESC" );
$arFilter = array("IBLOCK_ID"=>2 , "ACTIVE"=>"Y","PROPERTY_LOT_LINK" => $arResult['ID']);
$arSelectFields = array("ID", "IBLOCK_ID", "CREATED_USER_NAME","DATE_ACTIVE_FROM","PROPERTY_PRICE");
//$arSelectFields = array("ID", "IBLOCK_ID", "CREATED_USER_NAME","DATE_ACTIVE_FROM","PROPERTY_*");
$res = CIBlockElement::GetList(
	$arOrder,$arFilter,false,false,$arSelectFields
//	Array(
